                            ...
                            <tbody>
                                @foreach ($fridgeListIngredients as $ingredient)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="quantities[{{ $ingredient->id }}]" class="py-2 px-4 w-16 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" min="1" value="{{ $quantity }}">
                                        </td>
                                        <td>
                                            <div class="space-x-2">
